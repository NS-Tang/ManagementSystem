...
登录与注册功能的实现流程：
 ![图4.1](blob/master/img/4.1.png) 登录与注册功能的实现流程
如图4.1，以将登录系统分为三部分，登录模块，注册模块以及进入管理系统之后的账户操作功能。
 
![图4.2](blob/master/img/4.2.png) 登录窗口
 
![图4.3](blob/master/img/4.3.png) 注册窗口
进入管理系统之后按指定按键则有如下窗口：
 
![图4.4](blob/master/img/4.4.png) 注销账号窗口
 
![图4.5](blob/master/img/4.5.png)更改密码窗口
注册功能、注销账号功能、更改密码功能都提供了文件操作，可以进行永久更改。

管理系统的功能都集成在管理系统窗口，如图4.6所示
 
![图4.6](blob/master/img/4.6.png) 管理系统窗口
